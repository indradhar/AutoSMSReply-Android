...
public class DisplayCustomCustom extends AppCompatActivity
{
    ListView lvShow;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        lvShow.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener()
        {
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                AlertDialog.Builder ab = new AlertDialog.Builder(DisplayCustomCustom.this);
                ab.setTitle("Action");
                ...
                ab.setPositiveButton("Yes", new DialogInterface.OnClickListener()
                {
                    public void onClick(DialogInterface dialog, int which)
                    {
                        try
                        {
                            db.execSQL("delete from custom_custom_messages where name='"+name+"'");
                            al.clear();
                            load();
                        }
                        catch (Exception e)
                        {
                            Toast.makeText(DisplayCustomCustom.this,"Error : "+e,Toast.LENGTH_LONG).show();
                        }
                    }
                });
    ...
    public void load()
    {
        Cursor cur = db.rawQuery("select * from custom_custom_messages", null);
        ...
        cur.close();
        ArrayAdapter aa = new ArrayAdapter(DisplayCustomCustom.this,android.R.layout.simple_list_item_1,al);
